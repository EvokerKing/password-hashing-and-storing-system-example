...
add_custom_target(ci_infer
    ...
    COMMAND cd ${PROJECT_BINARY_DIR}/build_infer && ${INFER_TOOL} compile -- ${CMAKE_COMMAND} -DCMAKE_BUILD_TYPE=Debug ../../.. -DJSON_BuildTests=ON
...
add_custom_target(ci_non_git_tests
    ...
    COMMAND cd ../../.. && for FILE in `${GIT_TOOL} ls-tree --name-only HEAD`\; do cp -r $$FILE ${PROJECT_BINARY_DIR}/build_non_git_tests/sources \; done
    COMMAND ${CMAKE_COMMAND}
        -DCMAKE_BUILD_TYPE=Debug -GNinja
        -DJSON_BuildTests=ON -DJSON_FastTests=ON
...
function(ci_add_cmake_flags_targets flag min_version)
    ...
    add_custom_target(${flag_target}_${min_version_var}
        ...
        COMMAND cd ${PROJECT_BINARY_DIR}/build_${flag_target}_${min_version_var}
            && ${cmake_binary} -Werror=dev ../../.. -D${flag}=ON
